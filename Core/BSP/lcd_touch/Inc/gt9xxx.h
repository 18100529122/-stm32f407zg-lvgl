...
#define GT9XXX_RST_GPIO_PORT I2C_RST_GPIO_Port
#define GT9XXX_RST_GPIO_PIN	 I2C_RST_Pin
...
#define GT9XXX_INT_GPIO_PORT EXIT1_GPIO_Port
#define GT9XXX_INT_GPIO_PIN	 EXIT1_Pin
